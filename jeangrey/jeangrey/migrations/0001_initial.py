# Generated by Django 2.0.7 on 2018-11-07 17:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jeangrey.Client')),
            ],
        ),
        migrations.CreateModel(
            name='Service',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('public_network', models.CharField(blank=True, max_length=100, null=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('service_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='jeangrey.Service')),
                ('vrf_id', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('client_network', models.CharField(blank=True, max_length=100)),
            ],
            bases=('jeangrey.service',),
        ),
        migrations.CreateModel(
