...
class ProjectAccessPort extends React.Component {
  constructor(props) {
    super(props);
  ...
  handleSubmit = (event) => {
    ...
    let data = { "access_port_id": this.state.accessPortId };

    HTTPPost(URLs['projects'] + "/" + this.state.projectId, data).then(() => { this.setState({successAlert: true}) })
    ...
    render() {
        ...
        return (
            ...
            <div className="col-md-6 order-md-1">
                <FormTitle>Add access port to project</FormTitle>
...
export default ProjectAccessPort;