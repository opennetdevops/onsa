...
class ProjectVrf extends React.Component {
  constructor(props) {
    super(props);
  ...
  handleSubmit = (event) => {
    ...
    // Request inventory for vrf.
    // Save access port id.

    let data = { "vrf_id": this.state.vrfId };

    let url = URLs['projects'] + "/" + this.state.projectId + "/vrfs"
    ...
    render() {
        ...
        return (
            ...
            <div className="col-md-6 order-md-1">
                <FormTitle>Add VRF to project</FormTitle>
