...
from .views import wrapper, service_activation, service, brownfield_service

urlpatterns = [ 
    # url(r'^select2/', include('django_select2.urls')),
    # path('/api/login', obtain_jwt_token),
    path('/api/services', require_http_methods(["GET","POST"])(service.ServiceView.as_view())),
    path('/api/brownfield/services', require_http_methods(["GET","POST"])(brownfield_service.ServiceView.as_view())),
