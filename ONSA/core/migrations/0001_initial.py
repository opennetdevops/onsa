# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2018-06-26 20:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resource_pool_id', models.CharField(blank=True, max_length=50)),
                ('datacenter_id', models.CharField(blank=True, max_length=50)),
                ('uplink_ip', models.GenericIPAddressField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('used', models.BooleanField(default=False)),
                ('hubs', models.ManyToManyField(to='core.Hub')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='core.Client')),
                ('hub', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.Hub')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sco', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Sco')),
            ],
        ),
        migrations.AddField(
            model_name='nsxpublicirsservice',
            name='portgroup',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Portgroup'),
        ),
        migrations.AddField(
            model_name='nsxpublicirsservice',
            name='public_network',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.IpPublicSegment'),
        ),
        migrations.AddField(
            model_name='nsxpublicirsservice',
            name='sco_port',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.ScoPort'),
        ),
        migrations.AddField(
            model_name='cpelessmplsservice',
            name='hub',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.Hub'),
        ),
        migrations.AddField(
            model_name='cpelessmplsservice',
            name='public_network',
